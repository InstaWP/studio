...
Quick rules: edit `site/*.html` (the source of truth); follow the page conventions in
CLAUDE.md; no fabricated proof (flag with `VERIFY`); stay in the design system; never
publish to production unless explicitly asked.
